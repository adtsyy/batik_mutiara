        ...
        <tbody>
            ...
            <tr class="border-t text-[13px]">
                ...
                <td class="py-2 text-center">
                    @if($c->akses && count(json_decode($c->akses)) > 0)
                        <span class="bg-green-200 text-green-700 px-2 py-1 rounded-full text-xs">
                            Aktif
                        </span>
                    @else
                        <span class="bg-red-200 text-red-700 px-2 py-1 rounded-full text-xs">
                            Nonaktif
                        </span>
                    @endif
                </td>
...
<div id="modalTambahKasir" 
    ...
    <div class="bg-white w-[520px] rounded-xl shadow-lg p-6 relative">
        ...
        <form action="{{ route('cashiers.store') }}" method="POST" class="mt-5 space-y-4">
            ...
            <!-- ======================== -->
            <!-- TOMBOL KLIK HAK AKSES -->
            <!-- ======================== -->
            <button type="button" onclick="openAccessModal()" class="w-full">
                <div class="border border-gray-300 rounded-lg bg-gray-100 px-3 py-3 w-full 
                            flex justify-center cursor-pointer hover:bg-gray-200 transition">
...
<div id="modalAkses"
    ...
    <div class="bg-white w-[420px] rounded-xl shadow-lg p-6 relative">
        ...
        <div class="mt-4 space-y-5 text-[14px]">
            ...
            <div>
                ...
                <label class="flex items-center space-x-3">
                    <input type="checkbox" class="aksesCheck" value="produk_tambah">
                    <span>Tambah Produk</span>
                </label>

                <label class="flex items-center space-x-3">
                    <input type="checkbox" class="aksesCheck" value="produk_lihat">
                    <span>Lihat Produk</span>
                </label>

                <label class="flex items-center space-x-3">
                    <input type="checkbox" class="aksesCheck" value="produk_edit">
                    <span>Edit Produk</span>
                </label>

                <label class="flex items-center space-x-3">
                    <input type="checkbox" class="aksesCheck" value="produk_hapus">
            ...
            <div>
                ...
                <label class="flex items-center space-x-3">
                    <input type="checkbox" class="aksesCheck" value="penjualan_tambah">
                    <span>Tambah Penjualan</span>
                </label>

                <label class="flex items-center space-x-3">
                    <input type="checkbox" class="aksesCheck" value="penjualan_lihat">
                    <span>Lihat Penjualan</span>
                </label>

                <label class="flex items-center space-x-3">
                    <input type="checkbox" class="aksesCheck" value="penjualan_edit">
                    <span>Edit Penjualan</span>
                </label>

                <label class="flex items-center space-x-3">
                    <input type="checkbox" class="aksesCheck" value="penjualan_hapus">
                    <span>Hapus Penjualan</span>
                </label>
            </div>
        ...
        <div class="flex justify-end space-x-3 mt-6">
            <button onclick="closeAccessModal()"
                class="px-5 py-2 border rounded-lg">Batal</button>

            <button onclick="saveAccess()"
                class="px-5 py-2 bg-[#8B4A0B] text-white rounded-lg hover:bg-[#713c09]">
                Simpan
            </button>
        </div>
...
<script>
    ...
    function saveAccess() {
        let selected = [];
        document.querySelectorAll(".aksesCheck:checked").forEach((c) => {
